...
class DnCNN_Refine(nn.Module):
    def __init__(self, sr):
        ...
        layers.append(nn.Conv2d(in_channels=1, out_channels=image_channels, kernel_size=kernel_size, padding=padding, bias=False))
        ...
        #self.out1 = nn.Conv2d(in_channels=n_channels, out_channels=image_channels, kernel_size=kernel_size, padding=padding, bias=False)
