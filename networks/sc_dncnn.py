...
class DnCNN_Refine(nn.Module):
    def __init__(self, depth=17, n_channels=64, image_channels=3, use_bnorm=True, kernel_size=3):
        ...
        self.dncnn_r = self.d_layers(depth=17, n_channels=64, image_channels=3, use_bnorm=True, kernel_size=3,padding = 1)
        self._initialize_weights()
        
    def d_layers(self,depth=17, n_channels=64, image_channels=3, use_bnorm=True, kernel_size=3,padding = 1):
        layers = []
