...
class SpatialAttention(nn.Module):
    def __init__(self,num_features=64):
        ...
        self.conv1 = nn.Conv2d(num_features,num_features//4,3,padding=1,bias=False)
        self.relu1 = nn.ReLU()
        self.conv2 = nn.Conv2d(num_features//4,1,3,padding=1,bias=False)
...
class SRFBN(nn.Module):
    def __init__(self,  in_channels, sr, out_channels, num_features, num_steps, num_groups, upscale_factor, act_type = 'prelu',  norm_type = None):
        ...
        self.ca = ChannelAttention(num_features,reduction=16)
