...
class SpatialAttention(nn.Module):
    def __init__(self, kernel_size=7):
      ...
      #ESA
        ...
        #strided convolution
        self.conv2 = nn.Conv2d(1, 16, kernel_size, stride=3,padding=pading,bias=False)
        #MaxPooling
        self.max_pool= nn.MaxPool2d(7)
        #Conv Groups
        self.conv3 = nn.Conv2d(16,64,kernel_size=3,padding=pading,bias=False)
        self.conv4 = nn.Conv2d(64,64,kernel_size=3,padding=pading,bias=False)
        self.conv5 = nn.Conv2d(64,16,kernel_size=3,padding=pading,bias=False)
        #1x1 layer
        self.conv6 = nn.Conv2d(16,1,kernel_size=1,padding=pading,bias=False)
